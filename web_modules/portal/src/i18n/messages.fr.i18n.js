...
const messages = {
  ...
  'page.help.scenario.poyang.title': 'Réserves d\'eau douce : un taux de remplissage devenu chaotique et de nouveaux problèmes de santé publique',
  'page.help.scenario.poyang.text': 'Mis en oeuvre par le SERTIT de Strasbourg et fédérér par l\'Académie des sciences chinoise, le suivi spaio-temporel du Poyang regroupe un grand nombre de partenaires depuis 2003, dont plusieurs laboratoires d\'excellence.<br/><br/>Les images satellites sont fournies par plusieurs agences spatiales, via le projet de coopération sino-européenne Dragon, pilotéer l\'Agence Spatiale Européenne et le Ministère Chinois de la Science et de la technologie. Complémentaire au traitement de données de surfaces du SERTIT, EGOS traite celles relatives aux hauteurs d\'eau, en coopération avec des partenaires spécialisés. Plusieurs instituts chinois de recherche formation participent également, en terme de relevés de terrain, de partage des données, de dissémination des résultats et de transfert onnaissances. En partenariat avec les pôles de données d\'observation de la Terre, les travaux reçoivent le soutien technique et financier des actions de R&D du CNES et de l\'ESA ainsi que du programme français Pléiades.',
  ...
  'page.menu.scenario-list': 'Liste des scenarii',
  ...
  'page.scenario-list.subtitle': 'Sélectionner un des ces scénarii pour visualiser les impacts du changement climatique',
