...
export default {
  ...
  scenarios: [
    ...
    },
    {
      id: 'DISAPPEAR_LAKES',
      thematic: 'WATER',
      title: 'The duce water supply: Big variations in lake level',
      abstract: 'At 6,380 kilometres, the Yangtze is the world’s third longest river and the geographic, ecological and cultural keystone of China, as well as a major economic corridor. Along its course lies Lake Poyang, the country’s largest freshwater lake, in fact a system of hundreds of lakes and marshes that undergoes big variations between the dry season and the monsoon. But for some time now, the ancestral dynamics of Poyang are being altered by humans and probably by climate change, with the risk that species could be lost and dangerous micro-organisms could proliferate.<br/><br/>In this hard-to-monitor region, the SERTIT regional image processing and remote sensing department at the University of Strasbourg has been working with Chinese partners since 2004 to survey Poyang by satellite. Among the many Earth-imaging missions contributing to this endeavour, very-high-resolution optical satellites can even distinguish features as small as fishing nets.<br/><br/>Close analysis of dates shows the lake is starting to empty ever earlier, even before it has reached full capacity. But water needs to persist for a certain time to sustain the environment and recharge ground water. Now, we are starting to see droughts immediately following periods of rain like in 2012 and 2013.<br/>Monitoring water surface area makes it possible to gauge annual submersion periods: blue zones are where water persisted longer than average, orange less than average.',
    ...
    {
      id: 'DISAPPEAR_LAKES_HEALTH',
      thematic: 'HEALTH',
      title: 'Réserves d\'eau douce : De nouveaux problèmes de santé publique',
      abstract: 'At 6,380 kilometres, the Yangtze is the world’s third longest river and the geographic, ecological and cultural keystone of China, as well as a major economic corridor. Along its course lies Lake Poyang, the country’s largest freshwater lake, in fact a system of hundreds of lakes and marshes that undergoes big variations between the dry season and the monsoon. But for some time now, the ancestral dynamics of Poyang are being altered by humans and probably by climate change, with the risk that species could be lost and dangerous micro-organisms could proliferate.<br/><br/>Schistosomiasis, also known as snail fever or bilharzia, gives sufferers a pot-bellied appearance and comes with risks of encephalitis and high blood pressure. Endemic to Lake Dongting for millennia, it has now spread all along the Yangtze River. The cause is Oncomelania sp, a small freshwater snail that hosts the disease and is only found where floodwaters persist for a certain time.',
      image: 'http://app.spaceclimateobservatory.org/resources/sco/poyang/p30_carte_globale.jpg',
      imgCopyright: 'Photo Credit: Zhang Z, Thu R, Ward MP, Xu W, Zhang L, and al. (2012)',
      initialPOILayerVisibility: true,
      poi: {
        lat: 29.648,
        lon: 116.685,
      ...
      legend: {
        type: 'VERTICAL',
        url: 'http://app.spaceclimateobservatory.org/mapserv?map=WMS_POYANG&version=1.3.0&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=LAND_USE&format=image/png&STYLE=default',
        title: 'Land use map',
      },
    },
    {
