...
export default {
  ...
  scenarios: [
    ...
    },
    {
      ...
      abstract: '6 380 km. Troisième plus long fleuve du monde, le Yang-Tsé est la clé géographique, écologique et culturelle de la Chine, un corridor économique majeur. Dans ses méandres se trouve Poyang, le plus grand lac d’eau douce de Chine. Avec des fluctuations importantes entre saison sèche et mousson, ce sont des centaines de retenues d’eau qui s’unissent et se désunissent. Mais depuis quelques temps, Poyang voit sa dynamique ancestrale modifiée par l’activité humaine, et probablement par le changement climatique, au risque de perdre des espèces et de favoriser de dangereux micro-organismes.<br/><br/>Le schistosomiasis, ou maladie du gros ventre, provoque des risques d’encéphalite et d’hypertension. Endémique au lac Dongting durant des millénaires, elle s’étend désormais tout le long du Yang-Tsé. En cause, oncomelania sp, un petit escargot hôte de la maladie, dont la présence est conditionnée par un certain temps d’inondation.<br/><br/>La télédétection a permis de cartographier puis de corréler les facteurs susceptibles de favoriser son développement : d’une part l’environnement aquatique, d’autre part les activités anthropiques liées à l’eau. Suivis par le Centre national de parasitologie de Shangaï, les travaux visent une prévention globale et locale.<br/><br/>La maladie s’étend dans tout le bassin du Yang-Tsé, où elle sévit depuis plus de 2 000 ans.<br/><br/>Facteurs environnementaux : une fois l’habitat de l’escargot caractérisé, la cartographie croisée des temps de submersion et du type de végétation permet de supposer sa présence potentielle dans certaines zones. Un suivi mensuel durant 3 ans révèle qu’un modèle établi une année n’est plus valable la suivante.<br/>Facteurs anthropiques : cartographies des filets de pêche (en noir) et des pâturages, car les buffles sont également vecteurs du schistosomiasis.',
      image: 'http://app.spaceclimateobservatory.org/resources/sco/poyang/p30_carte_globale.jpg',
      imgCopyright: 'Crédit Photo : Zhang Z, Thu R, Ward MP, Xu W, Zhang L, and al. (2012)',	      		  initialPOILayerVisibility: true,
      poi: {
        lat: 29.648,
        lon: 116.685,
      },
