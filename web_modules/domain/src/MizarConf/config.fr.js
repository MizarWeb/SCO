  ...
  scenarios: [
    {
      ...
      abstract: 'Le réchauffement climatique provoque simultanément la dilatation des océans et la fonte des glaces continentales, dont les calottes polaires. Il en résulte une <b>hausse moyenne de 3,3 mm par an</b> du niveau des océans.<br/><br/>Cette crue inexorable a des conséquences immédiates sur les littoraux, comme <b>la submersion permanente des côtes basses, les submersions tempétueuses accrues, et la salinisation des aquifères</b>. Les régions doivent aujourd’hui surveiller l’évolution du trait de côte afin d’anticiper les impacts associés et établir une stratégie de défense.<br/>Développée par le Legos, une procédure spatiale permet d’évaluer un indice de la vulnérabilité des côtes. Combinant les données de satellites d’altimétrie et d’imagerie spatiale, il traduit la topographie locale d’une zone sur un modèle numérique de terrain (MNT) et compare cette topographie à la hausse du niveau de la mer. Cette approche permet d’<b>identifier les zones potentiellement soumises aux submersions permanentes ou occasionelles</b> (lors des tempetes) à cause de la hausse du niveau de la mer.<br/><br/>Cette méthode spatiale a été développée sur Palavas-les-Flots (sud-est de la France), choisie comme zone témoin en raison de ses nombreuses mesures de terrain. L\'Objectif premier est d\'évaluer le risque de la hausse des océans : les submersions permanentes ou les submersions tempétueuses.<br/><br/>La submersion dépend du niveau de l\'eau et du niveau du sol.',
      ...
      graph: {
        ...
        layout: {
          ...
          height: '300',
          title: 'Variation du niveau de la mer à Palavas',
          autosize: true,
